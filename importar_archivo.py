class ImportarArchivo:
    def __init__(self, ruta_defunciones, ruta_poblacion):
        self.ruta_defunciones = ruta_defunciones
        self.ruta_poblacion = ruta_poblacion
    ...
    def importar_dataset_poblacion(self):
        import pandas as pd
        import os
        path_poblacion = os.path.abspath(self.ruta_poblacion)
    ...
    def importar_dataset_defunciones(self):
        ...
        path_defunciones = os.path.abspath(self.ruta_defunciones)
